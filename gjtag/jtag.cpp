...
/* - 22/11/2014 [Mayubin]: change it for AT91SAM9260						 */
...
#define JTAG_DELAY() Delay(100)	    //delay=delayLoopCount
...
void JTAG_ReadId(void)
{
	...
	switch(id32)
	{
	case 0x0792603f:	// AT91SAM9260 
		printf("> AT91SAM9260(ID=0x%08x) is detected.\n",id32);
		break;
